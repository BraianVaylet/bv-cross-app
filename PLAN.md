...
| F3 | CRM: gestión del gimnasio | 12 | [docs/tasks/F3.md](docs/tasks/F3.md) | 🔨 8/12 |
...
- [x] **F3-11** 🟢 Sonnet — Configuración de la org: settings, joinCode, gestión de admins (+ extensión de roles en API)
