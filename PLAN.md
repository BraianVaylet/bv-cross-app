...
| F1 | API core: auth + organizaciones | 12 | [docs/tasks/F1.md](docs/tasks/F1.md) | 🔨 6/12 |
...
- [ ] **F2-05** 🟡 Sonnet — Home: catálogo del gimnasio + "Mis ejercicios" (paridad v1 en detalle/calculadora)
- [ ] **F2-06** 🟢 Sonnet — PWA (prompt de actualización) + pantalla de cuenta (nombre, password, cambiar de gym)
